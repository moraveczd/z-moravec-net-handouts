...
\begin{compactitem}
	...
	\item Slabá zásada a její sůl: $\textrm{pH} = 14 - pK_b + \log\frac{[B^+]}{[BH]}$
\end{compactitem}
...
\makeextracolumn{
    \textbf{Kyselina}
    \begin{compactitem}
        \item Látka, která uvolňuje protony, např. HCl nebo \ce{H2SO4}
    \end{compactitem}

	\textbf{Zásada}
	\begin{compactitem}
		\item Látka, která přijímá protony, např. NaOH
	\end{compactitem}
	...
	\begin{compactitem}
		...
		\item Acetátový pufr: směs kyseliny octové a octanu sodného
		\item Fosfátový pufr: směs dihydrogenfosforečnanu sodného a hydrogenfosforečnanu sodného
	\end{compactitem}
}
